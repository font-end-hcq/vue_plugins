<template>
<section class='mm-course-tab' id='simple'>
  ...
  <!-- <swiper v-model="index" :show-dots="false" id='my-swiper'> -->
    <!-- <swiper-item v-for="(item, index) in swiperList" :key="index"> -->
      <div class="tab-swiper vux-center" v-for="(item, index) in swiperList">
        <mm-course-list v-if='item.message' v-for='it in item.message' :pingjia='it.end'  :message='it' :to='"course_detl?courseId="+it._id' />
